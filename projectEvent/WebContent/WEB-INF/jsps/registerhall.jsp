...
<form action="hallprocess" method="post">
Name:<input type="text" name="name" id="name"><br>
Enter Hall Id:<input type="number" name="hallid" id="hallid"><br>
Enter Hall Name:<input type="text" name="hallname" id="hallname"><br>
